...
We propose MAGSAT, a unified framework that combines shape-invariant operator fusion with shape-adaptive parameter selection for dynamic workloads.
...
that MAGSAT achieves average speedups of 4.65$\times$ for fused operators and 2.74$\times$ for end-to-end inference
over the state-of-the-art baseline.
%up to XX$\times$ speedup for fused operators and XX$\times$ speedup for end-to-end inference.
%
%consistently outperforms existing works,  achieving 
\end{abstract}
