...
\input{1-Introduction.tex} %1.25 pages
\input{2-Background.tex}  %1.5 pages
\input{3-Motivation.tex}  %0.75 pages 
\input{4-Method.tex}  %3 pages
\input{5-Evaluation.tex} %4.25 pages
\input{6-Relatedwork.tex} %0.5 pages
\input{7-Conclusion.tex} %0.25 pages
